...
<main class="mt-5  pt-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" name="phone_no" value="<?php echo $user['phone_no'] ?>">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <?php if ($_SESSION['user']['profile_pic']) { ?>
                                            <img src="
                                            <?php echo BASE_URL . 'assect/uploads/' . $_SESSION['user']['profile_pic'] ?>" style="position:absolute;
  right:17px;
  width:38px;
  bottom:71px;
  border-radius:6px 6px 6px 6px;">
                                ...
                                <div class="col-md-12">
                                    <button type="submit" name="profile_submit" class="btn btn-success">Save</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="<?php echo BASE_URL ?>my-profile.php">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <button type="submit" name="password_submit" class="btn btn-success">Submit</button>
                                </div>
                        </form>
                    </div>
                </div>
